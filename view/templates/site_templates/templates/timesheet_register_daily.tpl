...
<form name="timesheet_daily_{$weekNumber}_{$curWeekday.iso_work_date}" method="post" accept-charset="utf8" class="py-2">
...
<div class="form-group mb-3">
  ...
  <input type="number" id="timesheet_hours_regular" name="timesheet_hours_regular" min="0" step="0.50" value="{$curWeekday.hours_regular}" tabindex="1" class="form-control form-control-lg text-end" required="required" autofocus="1" />
</div>
<div class="form-group mb-3">
  <label for="timesheet_hours_overtime" class="form-label">Overtime hours:</label>
  <input type="number" id="timesheet_hours_overtime" name="timesheet_hours_overtime" min="0" step="0.50" value="{$curWeekday.hours_overtime}" tabindex="2" class="form-control form-control-lg text-end"/>
</div>
<div class="form-group mb-3">
  <label for="timesheet_hours_break" class="form-label">Break hours:</label>
  <input type="number" id="timesheet_hours_break" name="timesheet_hours_break" min="0" step="0.50" value="{$curWeekday.hours_break}" tabindex="3" class="form-control form-control-lg text-end" required="required" />
</div>
