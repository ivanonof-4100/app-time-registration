...
{include file="std_cal_date.tpl" displayDate=$curWeekday.work_date weekday=$curWeekday.weekday_name weekdayShort=$curWeekday.weekday_name_short arrLocalizedMonths=$arrLocalizedMonths}
&nbsp;&nbsp;&nbsp;&nbsp;
