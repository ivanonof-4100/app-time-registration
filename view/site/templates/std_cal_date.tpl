...
<div class="outer" style="width:110px;height:110px;">
  ...
  <div class="inner rounded-corners" style="width:96px;height:76px;z-index:2;top:27px;margin-left:7px;margin-right:7px;background-color:#fff;color:#222;">
