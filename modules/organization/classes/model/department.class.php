 ...
 *
 * Description:
 *  An department model-class that handels access to data and attributes and persisting data into the database.
 */
class Department extends StdModel implements SaveableObjectInterface
{
    const db_table_name = 'department';
