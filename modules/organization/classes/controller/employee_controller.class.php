<?php
namespace App\Modules\Organization\Classes\Controller;
...
/**
 * Filename  : employee_controller.class.php
 * Language     : PHP v7.4+
 * Date created : IMA, 25/10-2022
 * Last modified: IMA, 25/10-2022
 * Developers   : @author IMA, Ivan Mark Andersen <ivanonof@gmail.com>
 *
 * @copyright: Copyright (C) 2022 by Ivan Mark Andersen
 *
 * Description:
 *  This class handles the flow-control and all the coordination in the proces of handling everything about employees.
 */
class EmployeeController extends StdController {
    // Attributes
    /**
     ...
     */
    public static function getInstance(string $p_lang ='da', string $p_charset ='utf8', StdApp $p_appInstance) : EmployeeController {
        $employeeController = new EmployeeController($p_lang, $p_charset, $p_appInstance);
        // Initialize dependencies and the registry of the web-app.
        $employeeController->initDependencies();
        return $employeeController;
    }
